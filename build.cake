...
{
    "Facade.Serialization.MessagePack.csproj",
	"Facade.Serialization.Json.csproj",
	"Facade.Serialization.Bson.csproj",
};
...
var solutionName = "Facades.Serialization.sln";
var nugetToken = Argument("nugetToken", "");
var nugetRepo = Argument("nugetRepo", "");
